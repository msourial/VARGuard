...
export interface DemoState { elapsedMs: number; running: boolean; speed: number; score: string; feed: "REPLAY" | "STALE"; naive: MarketState; guard: MarketState; actions: RiskAction[]; receipts: AuditReceipt[]; timeline: MatchEvent[]; timeToSuspendMs?: number; }
